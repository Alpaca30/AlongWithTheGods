...
/*
Source From https://forum.unity.com/threads/read-write-ini-file-o-config-file.244770/
*/
public class INIWorker
{
    private static string path = Path.Combine(Application.persistentDataPath, "settings.ini");
...
#if UNITY_EDITOR
        //Debug.LogFormat("Section: {0}, key: {1}, Value: {2}", _Section, _Key, _Value);
#endif
    }
    /// <summary>
